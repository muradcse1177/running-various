...
<div class="wrapper row4">
  <div id="container" class="clear">
	...
	<!-- ####################################################################################################### -->
	<h1 class="title">Examination notice</h1><br><br>

    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='examination' ORDER BY id DESC");
 ...
 <?php
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_examination_process.php" enctype="multipart/form-data">
		<table>
			<tr>
				<td>title:</td>
