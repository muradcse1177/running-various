...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
	<h1 class="title">Class Nine Result  </h1>
	...
	<?php
	 ...
	 $res = mysql_query("SELECT * FROM result WHERE category='nine' ORDER BY id DESC");
	 $i=0;
 ...
 <?php }
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_result_nine_process.php">
		<table>
			<tr>
				<td>Name:</td>
