...
<div class="wrapper row1">
  <div id="header" class="clear">
    <div class="fl_left">
      <h1><a href="index.html">Naildi B.S.S High School</a></h1>
       <td width="250"><form id="form1" name="form1" method="post" action="" >
              <table width="200" border="0" float="left" cellpadding="0" cellspacing="0";margin-top:5px;>
                <tr>
                  <td width="80" class="search">Quick Search : </td>
...
<div class="wrapper row2">
  <div id="topnav">
    <ul>
      ...
      <li><a href="About Teachers.html">About Teachers</a></li>
      <li><a href="full-width.html">About</a></li>
...
<div class="wrapper row5">
  <div id="footer" class="clear">
    ...
    <div class="foot_contact">
      <h2>School Name:XXXXXXXX</h2>
      <address>
      Address Line 1:xxxxxxxx<br />
      Address Line 2:xxxxxxxx<br />
      Town/City:xxxxxxxx<br />
