...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
	<h1 class="title">Class Six Students </h1>
	...
	<?php
	  ...
	  $res = mysql_query("SELECT * FROM student WHERE category='six' ORDER BY id DESC");
	 $i=0;
 ...
 <?php }
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_six_process.php">
		<table>
			<tr>
				<td>Name:</td>
