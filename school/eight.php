...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
	<h1 class="title">Class Eight Students </h1>
	...
	$res = mysql_query("SELECT * FROM student WHERE category='eight' ORDER BY id DESC");
	 $i=0;
	 ...
	 $i++;  ?>
			...
			<td width="100"><?php echo $row['roll'] ;  ?></td>
			<td width="200"><?php echo $row['Father'] ;  ?></td>
			<td width="200"><?php echo $row['Mother'] ;  ?></td>
			<td width="200"><?php echo $row['village'] ;  ?></td>
 ...
 <?php }
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_eight_process.php">
		<table>
			<tr>
				<td>Name:</td>
			...
			<tr>
				<td>Roll:</td>
				<td><input type="text" name="roll"required></input></td>
			</tr>
			<tr>
				<td>Father:</td>
				<td><input type="text" name="Father"required></input></td>
			</tr>
			<tr>
				<td>Mother:</td>
				<td><input type="text" name="Mother"required></input></td>
			</tr>
			<tr>
				<td>Village:</td>
				<td><input type="text" name="village"required></input></td>
			</tr>
			<tr>
				<td>Post:</td>
				<td><input type="text" name="post"required></input></td>
			</tr>
