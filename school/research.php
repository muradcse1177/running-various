...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
   <h1 class="title"> Recherch Update</h1><br><br>
    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='research' ORDER BY id DESC");
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_research_process.php" enctype="multipart/form-data">
		<table>
			<tr>
				<td>title:</td>
