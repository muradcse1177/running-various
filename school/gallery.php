...
<div id="homepage" class="clear">
   <h1 class="title">VIDEOS</h1>
    <div id="gallery" class="clear">
	  ...
	  <?php
		$res = mysql_query("SELECT * FROM gallery WHERE category='video' ORDER BY id DESC");
		while($row = mysql_fetch_array($res)){  ?>
			<div class="fl_left">
			  <video width="310" height="165" controls>
		...
		<p><a href="delete_gallery.php?id=<?php echo $row['id'] ?>">Delete</a></p> 
		<?php  } ?>
		<!-- ####################################################################################################### -->
...
<div  style="clear:both"></div>		
  ...
  ?>
	...
	<form method="post" action="add_gallery_process.php" enctype="multipart/form-data">
		<table>
			<tr>
...
<h1 class="title">IMAGES</h1>
	   <?php
		$res = mysql_query("SELECT * FROM gallery WHERE category='image' ORDER BY id DESC");
		while($row = mysql_fetch_array($res)){  ?>
			<div class="fl_left">
			 <div class="single_notice">
        
		  <p><img width="310" height="165" src=<?php echo '"'.$row['link'].'"'; ?>> </p>
...
<div  style="clear:both"></div>	
  ...
  ?>	  
	<form method="post" action="add_gallery2_process.php" enctype="multipart/form-data">
		<table>
			<tr>
