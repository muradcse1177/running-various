...
<div class="wrapper row4">
  <div id="container" class="clear">
    ...
    <div id="homepage" class="clear">
      <div class="fl_left">
	  <h2 class="title" >Hostel Life of The Students</h2>
      ...
      <!-- ############### -->
      <div class="fl_right">
        <h2 class="title">Hohtel Life of The Students </h2>
		<h2> Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Nullam quis turpis eu libero varius vestibulum. In feugiat. Sed et turpis ac risus aliquet rhoncus.</h2><br>
               
                  <h2>Nam cursus molestie metus. Aliquam ac neque nec leo condimenlis congue mauris. Cum sociis natoque penatibus et magnis.</h2><br>
