...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
	<h1 class="title">Class Ten Students </h1>
	...
	<?php
	 ...
	 $res = mysql_query("SELECT * FROM student WHERE category='ten' ORDER BY id DESC");
	 $i=0;
 ...
 <?php }
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_ten_process.php">
		<table>
			<tr>
				<td>Name:</td>
