...
<div class="wrapper row4">
  <div id="container" class="clear">
	...
	<!-- ####################################################################################################### -->
	<h1 class="title">Cultural Function notice</h1><br><br>

    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='cultural' ORDER BY id DESC");
    while($row = mysql_fetch_array($res)){  ?>
      <div class="single_notice">
        <h2 class="title"> <?php echo $row['title']; ?> </h2>
        <p><?php echo $row['notice']; ?></p>
		<p><a href=<?php echo '"'.$row['file'].'"'; ?>>download file</a> </p>
		
		<!-- ####################################################################################################### -->
		<?php if (isset($_SESSION['user_title']) && ($_SESSION['user_title']=='teacher')) { ?>
		<p><a href="delete_notice.php?id=<?php echo $row['id'] ?>">Delete Notice</a></p> 
		<?php  } ?>
		<!-- ####################################################################################################### -->
      </div>
    <?php }
 ...
 <?php
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_cultural_process.php" enctype="multipart/form-data"">
		<table>
			<tr>
				<td>title:</td>
			...
			<tr>
			  <td>notice:</td>
              <td><textarea name="notice" rows="5" cols="" style="width:180px;"required></textarea></td>
