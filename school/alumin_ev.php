...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
   <h1 class="title"> Alumini Event Notice</h1>
    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='alumini' ORDER BY id DESC");
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_alumin_ev_process.php" enctype="multipart/form-data">
		<table>
			<tr>
				<td>title:</td>
