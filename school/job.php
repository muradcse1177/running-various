...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
   <h1 class="title">Job vacanci Notice  </h1>
    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='job' ORDER BY id DESC");
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_job_process.php" enctype="multipart/form-data">
		<table>
			<tr>
				<td>title:</td>
