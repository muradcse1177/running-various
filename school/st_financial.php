...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
   <h1 class="title">The School helps the meritorious student by giving financial service  </h1>
   <h1 class="title">Notice For Student Financial Service </h1>
    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='st_financial' ORDER BY id DESC");
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_st_financial_process.php" enctype="multipart/form-data">
		<table>
			<tr>
				<td>title:</td>
