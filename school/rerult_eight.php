...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
    <!-- ####################################################################################################### -->
	<h1 class="title">Class Eight Result  </h1>
	...
	<?php
	 ...
	 $res = mysql_query("SELECT * FROM result WHERE category='eight' ORDER BY id DESC");
	 $i=0;
 ...
 <?php }
  ...
  <div id="container" class="clear">
	...
	<form method="post" action="add_result_eight_process.php">
		<table>
			<tr>
				<td>Name:</td>
			...
			<tr>
				<td>Marks:</td>
				<td><input type="text" name="marks"required></input></td>
			</tr>
			<tr>
