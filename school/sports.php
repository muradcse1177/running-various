...
<div class="wrapper row4">
  <div id="container" class="clear">
	...
	<!-- ####################################################################################################### -->
	<h1>Sports notice</h1><br><br>

    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='sports' ORDER BY id DESC");
  ...
  <div id="container" class="clear">
  <form method="post" action="add_sports_process.php" enctype="multipart/form-data">
	<table>
			<tr>
				<td>title:</td>
