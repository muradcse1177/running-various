...
<div class="wrapper row4">
  ...
  <div id="homepage" class="clear">
   <!-- ####################################################################################################### -->
    <h1 class="title">Articles Notice</h1><br><br>
    <?php
    include "includes/connection.php";
    $res = mysql_query("SELECT * FROM notice WHERE category='articles' ORDER BY id DESC");
  ...
  <form method="post" action="add_articles_process.php" enctype="multipart/form-data" >
    <table>
			<tr>
				<td>title:</td>
