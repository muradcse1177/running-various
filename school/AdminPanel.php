...
<div class="wrapper row4">
  ...
  <h1 class="title">Approve page <a href="admin-approve.php"> click here</a></h1><br><br>
    <!-- ####################################################################################################### -->
	  
    <h1 class="title">Comment for Students</h1> 
  <?php
		
		$res = mysql_query("SELECT * FROM comments WHERE category='student' ORDER BY id DESC");
		
		 while($row = mysql_fetch_array($res)){  ?>
			<div class="single_request" style="padding:20px">
					<h1 class="title"><?php echo "ID: ".$row['id'].", Name: ".$row['name'].", Education: ".$row['edu'].", Email: ".$row['email'].", Phone: ".$row['pn_num'];?></h1>
