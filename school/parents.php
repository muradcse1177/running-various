...
<div class="wrapper row4">
  <div id="container" class="clear">
    ...
    <div id="homepage" class="clear">
      <div class="fl_left">
	  <h1 class="title">Comments for Parents<h1>
        <div class="comment">
                  ...
                  <tbody><tr>
                    <td valign="top"><form id="form2" name="form2" method="post" action="Gr_cmnt.php">
                      <table class="border" align="center" border="0" cellpadding="2" cellspacing="2" width="98%">
                        ...
                        <tr>
                          <td width="34%">Gurdian Name:</td>
                          <td  width="66%"><input name="textfield3" style="width:180px; height:13px;" type="text" required></td>
                        </tr>
                        <tr>
                          <td width="34%">Student Name:</td>
                          <td  width="66%"><input name="textfield34" style="width:180px; height:13px;" type="text" required></td>
                        </tr>
                        <tr>
                          <td>Gender:</td>
                          <td>
    ...
    $res = mysql_query("SELECT * FROM comments WHERE category='parents' ORDER BY id DESC");
  
    while($row = mysql_fetch_array($res)){ ?>
      <div class="single_request" style="padding:20px">
          <h1 class="title"><?php echo "ID: ".$row['id'].", Gurdian Name: ".$row['name'].", Student Name: ".$row['st_name'].", Education: ".$row['edu'].", Email: ".$row['email'].", Phone: ".$row['pn_num'];?></h1>
